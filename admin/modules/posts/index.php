...
<form method="GET" action="">
    ...
    <td height="40px">
					<fieldset style="border: 2px solid black">
						<legend style="color: black;"><h2><b>Tìm bài viết</b></h2></legend>
    ...
    <td width=580px></td>    
    <td>
        <a href="./add_post.php" class="btn btn-primary"><h3><b>Thêm bài viết</b></h3></a>
    </td>         
    </table>
    <br><br>    
     ...
     ?>
                    <tr>
                        ...
                        <td style="height: 280px; width: 280px"><?= $row['image_path'] ?></td>
