            ...
            <div class="detail col-6" style="margin-left: 30px;">
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" value="1" id="number" min="1" placeholder="Nhập số lượng" name="qty">
                    </div>
                    <div class="mb-3">
